...
const primaryMessage = `A
    <a href="https://ae.studio/same-day-skunkworks" class="utils-underline" target="_blank" rel="noreferrer">SDS</a>
    Project • Made with
    <img
