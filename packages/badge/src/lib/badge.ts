...
const primaryMessage = `A
    <a href="https://ae.studio/same-day-skunkworks" class="sds-underline" target="_blank" rel="noreferrer">SDS</a>
    Project • Made with
    <img
      ...
      width="10"
      height="10"
      class="sds-utils-badge-inline"> by <a href="https://ae.studio/" target="_blank" class="sds-underline">Agency Enterprise</a>`;
...
async function SDSUtilsBadge({
  ...
  cssLink.href =
    'https://cdn.jsdelivr.net/gh/agencyenterprise/sds-utils@1.2.6/dist/packages/badge/src/lib/badge.css';
