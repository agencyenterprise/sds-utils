...
function SDSUtilsBadge(_a) {
    var location = _a.location, position = _a.position, _b = _a.theme, theme = _b === void 0 ? ThemeOptionsEnum.Light : _b, expandable = _a.expandable, showPricing = _a.showPricing, features = _a.features, showHeader = _a.showHeader, target = _a.target;
    return __awaiter(this, void 0, void 0, function () {
        var analyticsScript, targetElement, header, headerDiv, footer, featuresDiv, featuresString, i, featuresDivHtml;
            ...
            if (showPricing == true) {
                ...
                if (features) {
                    if ((features === null || features === void 0 ? void 0 : features.length) > 0) {
                        ...
                        targetElement === null || targetElement === void 0 ? void 0 : targetElement.appendChild(featuresDiv);
                    }
                }
